        ...
        <section className={styles.projectContainer}>
          <article>
            ...
            <a href="https://github.com/Rheisen/xavier-config" target="_blank" rel="noopener noreferrer">
              <span>View Xavier Config on GitHub</span>
            </a>
          </article>
        </section>
        ...
        <section className={styles.projectContainer}>
          <article>
            ...
            <p>
              ...
              has allowed me to experiment with numerous technologies. Eventually I would like for it to help people
        ...
        <section className={styles.projectContainer}>
          <article>
            ...
            <a href="https://github.com/Rheisen/rheisen-web" target="_blank" rel="noopener noreferrer">
              <span>View Rheisen.me frontend on GitHub</span>
            </a>
          </article>
        </section>
      </div>
